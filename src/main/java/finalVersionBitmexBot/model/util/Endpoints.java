...
public class Endpoints {
    ...
    public static final String BASE_TEST_URL_WEBSOCKET_2 = "wss://testnet.bitmex.com/realtime";
    ...
    public static final String COUNT_100_REVERSE_FALSE = "?count=100&reverse=false";
}
